...
public class SemDDA extends Applet implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource()==b3)
		{
			...
			InputHandler iw = new InputHandler();
			int numberOfDatabaseStatements = CountDatabaseStatements.main(inputMain);
		...
		else if(e.getSource()==b11)
		{
			...
			long ts1 = System.currentTimeMillis();
			String time1 = ts1+"";
			int array[][] = SemanticAnalysis.main(outputMain);
			String str = "";
			int count = 0;
		...
		else if(e.getSource()==b14)
		{
			...
			if(opt==1)
				...
				array = SemanticAnalysis.main(outputMain);
